...
type Props = {
  ...
  rows: BusinessProfileServiceItem[];
  isLoading: boolean;
  totalItems: number;
  page: number;
  rowsPerPage: number;
  ...
  onAddClick: () => void;
  onEditClick: (row: BusinessProfileServiceItem) => void;
    ...
    <SideNavLayout>
      <div className="p-4">
        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm md:p-6 min-h-[calc(100vh-140px)]">
          ...
          <BusinessProfileViewTabs profileId={id} activeTab="services" />
            ...
            <div className="mb-4 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              ...
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-end">
                ...
                {/* <select
                  ...
                  onChange={(e) =>
                    onStatusFilterChange(
                      e.target.value as "ALL" | CatalogStatus
                    )
                  }
                  className="rounded-md border border-slate-300 px-3 py-2 text-sm outline-none focus:border-slate-400"
                >
