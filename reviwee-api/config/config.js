...
const envVarsSchema = Joi.object().keys({
  ...
  GOOGLE_CLIENT_ID: Joi.string().description("google map api keys"),
  RAZORPAY_WEBHOOK_SECRET: Joi.string().description("razorpay webhook secret"),
  RABBITMQ_URL: Joi.string()
    .default("amqp://localhost")
    .description("rabbit mq url"),
  GATEWAY_HASH_SECRET: Joi.string()
    .default("gateway hash")
    .description("gateway hash"),
});
...
module.exports = {
  ...
  gateway_hash_secret: envVars.GATEWAY_HASH_SECRET,
};
