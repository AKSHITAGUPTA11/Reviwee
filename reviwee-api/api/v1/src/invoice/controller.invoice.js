...
const adminService = require("../admins/service.admin");
const { searchKeys } = require("./schema.invoice");
...
exports.allFilterPagination = async (req, res) => {
  try {
    ...
    //-----------------------------------
    let dataFound = await invoiceService.aggregateQuery(finalAggregateQuery);
    ...
    let result = await invoiceService.aggregateQuery(finalAggregateQuery);
    if (result.length) {
...
exports.get = async (req, res) => {
  try {
    ...
    let dataExist = await invoiceService.aggregateQuery(additionalQuery);
