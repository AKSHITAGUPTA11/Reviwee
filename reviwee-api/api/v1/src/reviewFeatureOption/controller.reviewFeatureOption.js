...
const { userEnum, variableEnum } = require("../../../utils/enumUtils");
  ...
  try {
    ...
    for (let opt of options) {
      ...
      if (!alreadyExist) {
        ...
        const variables = extractVariablesFromText(featureOption);
        ...
        insertData.push({
          ...
          language,
          variables,
          addedById: req.userData.Id,
          addedByName: req.userData.name,
        });
      }
    }
...
exports.update = async (req, res) => {
  try {
    ...
    // extract variables again on update
    const variables = extractVariablesFromText(featureOption);
...
exports.allFilterPagination = async (req, res) => {
  try {
    ...
    let booleanFields = [];
    let numberFileds = [];
    let objectIdFields = ["categoryId", "subCategoryId", "reviewFeatureId"];
