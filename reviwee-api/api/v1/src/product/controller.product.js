...
const { searchKeys } = require("./schema.product");
...
exports.add = async (req, res) => {
  try {
    let { products, businessId } = req.body;
     ...
     */
    const existingProducts = await productService.findAllWithQuery({
      businessId,
    ...
    /**
     * filter new products (remove duplicates)
     */
    ...
    if (!newProducts.length) {
      throw new ApiError(httpStatus.OK, "All products already exist.");
    }

    /**
     * prepare data for bulk insert
     */
    const payload = newProducts.map((name) => ({
      businessId,
      productName: name,
    }));
     ...
     * create many
     */
    const dataCreated = await productService.createMany(payload);
...
exports.update = async (req, res) => {
  try {
    let { productName, businessId } = req.body;
    ...
    if (dataExist) {
      throw new ApiError(httpStatus.OK, "Product already exist.");
    }
