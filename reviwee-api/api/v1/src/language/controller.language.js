...
const { searchKeys } = require("./schema.language");
...
exports.add = async (req, res) => {
  try {
    let { languageName, languageDescription } = req.body;
    ...
    if (dataExist) {
      throw new ApiError(httpStatus.OK, "Language already exist.");
    }

    //------------------create data-------------------
    let dataCreated = await languageService.createNewData({
      ...req.body,
    });
...
exports.get = async (req, res) => {
  try {
    ...
    let dataExist = await languageService.aggregateQuery(additionalQuery);
