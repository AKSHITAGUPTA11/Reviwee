  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={onMoreClick}
        className="flex flex-col items-center justify-center flex-1 min-w-0 h-full py-1 px-1 text-[12px] text-[var(--text-secondary)] transition-all duration-200"
        aria-label="More menu"
      >
        <MdMoreHoriz className="text-[22px] shrink-0 mb-0.5" />
