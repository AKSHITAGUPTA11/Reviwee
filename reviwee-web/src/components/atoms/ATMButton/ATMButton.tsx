...
const ATMButton = ({
  ...
  return (
    <button
      ...
      className={`border w-full bg-[#00144F] text-white rounded p-2 h-[42px] flex gap-2 justify-center items-center 
        ${className} ${
    ...
    >
      {isLoading ? (
        <>
          <svg
            aria-hidden="true"
            className="mr-2 w-5 h-5 text-gray-200 animate-spin dark:text-gray-600 bg-[#00144F]"
            viewBox="0 0 100 101"
            fill="none"
          ...
          >
            <path
              d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 
                 ...
                 50 9.67226C27.4013 9.67226 9.08144 27.9921 
                 9.08144 50.5908Z"
              fill="currentColor"
            />
            <path
